...
Вуаля! Маршрут наконец появился в таблице.



Остается выполнить фильтрацию маршутов. Она выполняется на R16. Задаем префикс-лист и используем его в исходящем направлении на интерфейсе для фильтрации. В ipv4 минимальная длина префикса 1 при использовании ge. 
