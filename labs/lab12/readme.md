...
8. [Все офисы в лабораторной работе должны иметь IP связность](#head8)
...
Альтернативно, нужно чтобы пакет от R15 приходил на R14 на не inside-интерфейс. Т.е. например сделать линк между маршрутизаторами и не маркировать его ни как outside, ни как inside. Тогда пакет на R14 будет транслирован корректно.
...
## <a name="head5"></a>Настроите статический NAT(PAT) для офиса Чокурдах
...
Результат - на клиенте установлено неправильное время, нет связи с серверами NTP.
