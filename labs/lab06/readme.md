...
* [Настраиваем SW12 и SW13 на получения маршрута по умолчанию, фильтрацию в зоне 102](#head130)
...
## <a name="head130"></a> Настраиваем SW12 и SW13 на получения маршрута по умолчанию, фильтрацию в зоне 102
