...
Рекомендуем сдать до: 26.04.2021

## Настройка R12-13 на OSPF в зоне 10
...
## Настройка R14-15 на OSPF в зоне 0
...
Префикса нет, но есть маршрут по умолчанию. Проверяем, будет ли связность с сетию, до который не прописан маршрут:
