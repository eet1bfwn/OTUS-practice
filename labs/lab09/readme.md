...
Связность есть. Однако в таблице маршрутизации находится неагрегированная сеть из офиса Москвы, хотя и агреггированная сеть тоже есть. Причина - была дана неполная команда на суммаризацию, без ключевого слова "summary-only"
