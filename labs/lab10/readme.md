...
1. [iBGP в офисом Москва между маршрутизаторами R14 и R15](#head1)
2. [Настроите iBGP в провайдере Триада](#head2)
3. [Настройте офиса Москва так, чтобы приоритетным провайдером стал Ламас.](#head3)
4. [Настройте офиса С.-Петербург так, чтобы трафик до любого офиса распределялся по двум линкам одновременно](#head4)
5. [Все сети в лабораторной работе должны иметь IP связность](#head4)
