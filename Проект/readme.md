...
Также стоит обратить внимание на возможности оборудования для хранения маршрутной информации. На каждом этаже заложено 10 коммутаторов доступа по 128 сетей на каждом. Это 1280 маршрутов, которые должны оказаться в таблице маршрутизации на коммутаторе распределения на этаже. В целях отказоустойчивости к коммутатору распределения на этаже будут подключены и коммутаторы одного соседнего этажа - это еще 1280 маршрутов. Т.е. максимальное число маршрутов до клиентских подсетей - 2560. К этим машрутам стоит прибавить маршруты до оборудования в ядре и в уровне распределения (порядка 100). Получим теоретический максимум нужной маршрутной информации. Современное оборуодование поддерживает такие объемы.
