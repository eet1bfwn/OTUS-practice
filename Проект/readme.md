...
2. [Реализация.](#realization)
   ...
   1. [Базовая настройка сети центрального офиса](#realization_base)
      1. [Планирование адресного пространства центрального офиса.](#realization_address_planning)
		 ...
		 1. [Таблица с адресами устройств, расположенных в лабораторной работе.](#realization_addr_result_summary)
      2. [Базовая настройка сетевых устройств.](#realization_base_config)
         1. [Включение ip маршрутизации.](#)
         2. [Настройка L2 на коммутаторах доступа.](#)
...
#### <a name="realization_addr_result_summary"></a>Таблица с адресами устройств, расположенных в лабораторной работе
...
Access-Floor-5-2: 0.010

Access-Floor-5-4: 0.100

Access-Floor-6-1: 0.001

Access-Floor-6-2: 0.010

Access-Floor-7-1: 0.001
...
| Устройство | Адрес сети |
| ------------- | ------------------------ | 
| Accounting-1 (Отдел 36)  | 00000                    | 
| HR-1 (Отдел 23)  | 00000                    | 
| HR-2 (Отдел 23)  | 00000                    | 
| HR-3 (Отдел 23)  | 00000                    | 
| Wi-Fi-1 (Отдел 65)  | 00000                    | 
| HR-4 (Отдел 23)  | 00000                    | 
| Accounting-2 (Отдел 36)  | 00000                    | 
| Wi-Fi-2 (Отдел 65)  | 00000                    | 
| Srv-Print-1 (Отдел 100)  | 00000                    | 
| Srv-Voice-1 (Отдел 101)  | 00000                    | 
...
Сеть устройства Accounting-1 (Отдел 36):
