...
Проектная работа заключается в создании работоспособной сетевой инфраструктуры.

# Содержание
[a relative link](other_file.md)
1. [Общая схема сети](Общая%20схема%20сети/readme.md)
   
   1. Сеть из трех провайдеров.
   1. Сеть центрального офиса компании GrowWide.
   1. Сеть в дата-центре.
   1. Сеть необольшого регионального офиса без автономной системы.
   1. Сеть еще одного небольшого офиса с уже использующейся в остальной сети адресацией.

1. Реализация.
	1. Базовая настройка сети центрального офиса
	   1. Планирование адресного пространства центрального офиса.
		  1. Исходные данные.
		  1. Требования к масштабируемости.
		  1. Расчет подсетей.
		  1. Результирующие правила адресации.
...
## Базовая настройка сети центрального офиса
### Планирование адресного пространства центрального офиса
#### Исходные данные
